...
| 2 | [Typed, read-only API tools](2-typed-api-tools.md) | 2 · Agent + API-Tools | `02`, `04` | [`solutions/2-typed-api-tools/`](../solutions/2-typed-api-tools/) |
| 3 | [RAG over a KB via your own MCP server](3-rag-and-mcp.md) | 3 · RAG & MCP | `05`, `07` | [`solutions/3-rag-and-mcp/`](../solutions/3-rag-and-mcp/) |
...
| 5 | [Use `skill-creator` to author a skill](5-skill-creator.md) | Capstone · Agent Skills | `06` | *(worked try-out in [`../experiments/skill-creator/`](../experiments/skill-creator/))* |
| 6 | [RAG over a Google OKF knowledge base](6-rag-okf.md) | 3 · RAG & MCP | `07` (`07_RAG_OKF.py`) | [`../07_RAG_OKF.py`](../07_RAG_OKF.py) |
