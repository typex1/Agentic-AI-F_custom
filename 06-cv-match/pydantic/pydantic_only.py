...
so it runs instantly and for free. It shows what pydantic contributes to the
Strands example in structured_output.py: type coercion, validation, and the
JSON schema that Strands sends to the model.
"""
