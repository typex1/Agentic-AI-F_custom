...
Hands-on practice with the Strands Agents SDK.

## Available Exercises

### 06: Customer Support Tickets (capstone)

**Path:** `tasks/06_customer_support_tickets/`
...
See `tasks/06_customer_support_tickets/TASK.md` for the full exercise description and `tasks/06_customer_support_tickets/code/` for the reference solution.
...
Step-by-step task descriptions for building agents incrementally:

| Task | Topic |
|------|-------|
| `01_chat_agent.md` | Build your first chat agent |
| `02_chat_agent_tools.md` | Add custom tools |
...
| `06_customer_support_tickets/` | Capstone project (see above) |

### Solutions

**Path:** `solutions/`

Reference implementations for the task sheets above.
